...
public class LessThanLessThan extends Inequality {

	private Expression _numericExpression1;
	private Expression _variable;
	private Expression _numericExpression2;
	
	public LessThanLessThan(Expression numericExpression1, Expression variable, Expression numericExpression2)
	{
		_variable = variable;
