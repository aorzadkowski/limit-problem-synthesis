...
public class BinaryMinus implements BinaryOperator {
    ...
    public Expression deepCopy()
    {
    	...
    	return new BinaryMinus(newExp1, newExp2);
    }
    
    public boolean equals(Expression other) {
    	if (other == null) return false;
    	if (!(other instanceof BinaryMinus)) return false;
    	if (((BinaryMinus)other).getExp1().equals(_exp1) && ((BinaryMinus)other).getExp2().equals(_exp2)) {
    		return true;
    	}
    	return false;
    }
