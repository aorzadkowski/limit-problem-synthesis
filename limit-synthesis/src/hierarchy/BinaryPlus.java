...
public class BinaryPlus implements BinaryOperator {
    ...
    public Expression deepCopy()
    {
    	...
    	return new BinaryPlus(newExp1, newExp2);
    }
    
    public boolean equals(Expression other) {

    	if (other == null) return false;
    	if (!(other instanceof BinaryPlus)) return false;
    	if (((BinaryPlus)other).getExp1().equals(_exp1) && ((BinaryPlus)other).getExp2().equals(_exp2)) {
    		return true;
    	}
    	return false;
    }
