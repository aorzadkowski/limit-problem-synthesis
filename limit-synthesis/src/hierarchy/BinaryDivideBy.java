...
public class BinaryDivideBy implements BinaryOperator
{
    ...
    public boolean validate()
    {
    	...
    	if(LimitExpression.PROHIBIT_NUM_OVER_NUM)
    	{
    ...
    public Expression deepCopy()
    {
    	...
    	return new BinaryDivideBy(newExp1, newExp2);
    }
    
    public boolean equals(Expression other) {
    	if (other == null) return false;
    	if (!(other instanceof BinaryDivideBy)) return false;
    	if (((BinaryDivideBy)other).getExp1().equals(_exp1) && ((BinaryDivideBy)other).getExp2().equals(_exp2)) {
    		return true;
    	}
    	return false;
    }
